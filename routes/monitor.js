...
function getOSDetails(){
  return {
    ...
    "release":os.release(),
    "uptime": ( os.uptime() / 60 ).toFixed(0) % 60,
    "uptimesecs": (os.uptime() % 60).toFixed(0),
    "uptimehours": ((os.uptime() / 60 ).toFixed(0) / 60).toFixed(0),
    "loadavg1":(os.loadavg()[0] * 100).toFixed(2),
    "loadavg5":(os.loadavg()[1] * 100).toFixed(2),
    "loadavg15":(os.loadavg()[2] * 100).toFixed(2),
